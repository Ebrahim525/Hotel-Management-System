...
Revision ID: 013bec4247ac
Revises: 
Create Date: 2025-04-03 22:35:44.836571
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('room_type', sa.Enum('Deluxe', 'Suite', 'Standard', name='room_types'), nullable=False),
